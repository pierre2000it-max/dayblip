...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "https://www.dayblip.com/api/og/daily?day=1&correct=true&streak=1&v=2", width: 1200, height: 630, alt: "Dayblip Daily Financial Challenge" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://www.dayblip.com/api/og/daily?day=1&correct=true&streak=1&v=2"],
  },
}
