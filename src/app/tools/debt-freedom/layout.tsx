...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/api/og?title=Debt+Freedom+Date+Calculator&emoji=%F0%9F%94%93&subtitle=The+exact+date+you+become+debt+free+%E2%80%94+Free", width: 1200, height: 630, alt: "Debt Freedom Date Calculator — Dayblip" }],
  },
