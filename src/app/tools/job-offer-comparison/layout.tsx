...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "https://www.dayblip.com/api/og?title=Job+Offer+Comparison+Calculator&emoji=%F0%9F%92%BC&subtitle=Which+offer+actually+pays+more%3F+%E2%80%94+Free", width: 1200, height: 630, alt: "Job Offer Comparison Calculator — Dayblip" }],
  },
  twitter: { card: "summary_large_image", images: ["https://www.dayblip.com/api/og?title=Job+Offer+Comparison+Calculator&emoji=%F0%9F%92%BC&subtitle=Which+offer+actually+pays+more%3F+%E2%80%94+Free"] },
}
