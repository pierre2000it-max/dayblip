...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.dayblip.com/api/og?title=Financial+Independence+Date&emoji=%F0%9F%8F%84&subtitle=Find+the+exact+date+you+can+stop+working+%E2%80%94+Free", width: 1200, height: 630, alt: "Financial Independence Date — Dayblip" }],
  },
  twitter: { card: "summary_large_image", images: ["https://www.dayblip.com/api/og?title=Financial+Independence+Date&emoji=%F0%9F%8F%84&subtitle=Find+the+exact+date+you+can+stop+working+%E2%80%94+Free"] },
}
