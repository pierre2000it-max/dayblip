...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "https://www.dayblip.com/api/og?title=Life+Insurance+Calculator&emoji=%F0%9F%9B%A1%EF%B8%8F&subtitle=How+much+life+insurance+do+you+need%3F+%E2%80%94+Free&v=2", width: 1200, height: 630, alt: "Life Insurance Calculator — Dayblip" }],
  },
  twitter: { card: "summary_large_image", images: ["https://www.dayblip.com/api/og?title=Life+Insurance+Calculator&emoji=%F0%9F%9B%A1%EF%B8%8F&subtitle=How+much+life+insurance+do+you+need%3F+%E2%80%94+Free&v=2"] },
}
