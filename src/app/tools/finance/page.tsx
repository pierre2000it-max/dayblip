...
export const metadata: Metadata = {
  title: "Finance Calculators — Free Tools for Every Money Decision | Dayblip",
  description: "23 free finance calculators for retirement, mortgage, debt, compound interest, taxes, net worth and more. No signup. No email.",
  alternates: { canonical: "https://www.dayblip.com/tools/finance" },
}
...
export default function ToolsFinancePage() {
  return (
    <div className="min-h-screen bg-[#1a1a2e]">
      <section className="px-6 py-20 text-center" style={{ background: "linear-gradient(135deg,#1a1a2e 0%,#0f3460 100%)" }}>
        <div className="mx-auto max-w-[700px]">
          ...
          <p className="text-lg text-[#a8a8b3]">23 free tools for every money decision — retirement, debt, taxes, investing and more</p>
        </div>
      </section>
