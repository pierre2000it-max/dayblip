...
export const metadata: Metadata = {
  title: 'Black Friday Deal Analyzer — Is It a Real Deal? | Dayblip',
  ...
  openGraph: {
    title: 'Black Friday Deal Analyzer — Real Deal or Fake? | Dayblip',
  ...
  twitter: {
    ...
    title: 'Black Friday Deal Analyzer | Dayblip',
