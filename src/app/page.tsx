  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        >
          Dayblip is a free tool site with 160+ interactive calculators covering personal finance, career decisions, life visualization and historical curiosity. No signup. No email. No paywall. Free forever.
        </p>
        ...
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {[
              ...
              { emoji: "🔢", title: "Life in Numbers", desc: "Your heartbeats and breaths, live", href: "/tools/life-in-numbers" },
              ...
              { emoji: "🎵", title: "Music of Your Year", desc: "Songs that defined your birth year", href: "/tools/music-of-your-year" },
