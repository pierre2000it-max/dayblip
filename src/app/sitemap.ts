...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    p("/embed/gpa-calculator",          0.7, MONTHLY),
    p("/embed/overtime-tax",            0.7, MONTHLY),
    p("/embed/tip-calculator",          0.7, MONTHLY),
    p("/embed/paycheck-calculator",     0.7, MONTHLY),
    p("/embed/due-date-calculator",     0.7, MONTHLY),
    p("/embed/currency-converter",      0.7, MONTHLY),
    p("/embed/percentage-calculator",   0.7, MONTHLY),
    p("/embed/sleep-calculator",        0.7, MONTHLY),
    p("/embed/calorie-calculator",      0.7, MONTHLY),
    p("/embed/body-fat",                0.7, MONTHLY),
    p("/embed/overtime-calculator",    0.7, MONTHLY),
    p("/embed/unit-converter",         0.7, MONTHLY),
    p("/embed/bmi-calculator",         0.7, MONTHLY),
    p("/embed/grade-calculator",       0.7, MONTHLY),
    p("/embed/water-intake",           0.7, MONTHLY),
