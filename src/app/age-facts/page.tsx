...
export const metadata: Metadata = {
  ...
  description: "Discover how many times your heart has beaten, how much you have slept and other measurable facts about your life.",
  keywords: ["how many times has my heart beaten", "fun age facts", "life stats calculator", "how many times have I breathed"],
  alternates: { canonical: "https://www.dayblip.com/age-facts" },
};
