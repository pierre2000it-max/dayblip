...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/api/og?title=Mortgage+Calculator&emoji=%F0%9F%8F%A0&subtitle=Monthly+payments+%26+amortization+%E2%80%94+Free+calculator", width: 1200, height: 630, alt: "Mortgage Calculator — Dayblip" }],
  },
