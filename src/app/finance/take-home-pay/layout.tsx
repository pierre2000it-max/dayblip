...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/api/og?title=Take+Home+Pay+Calculator&emoji=%F0%9F%92%B5&subtitle=Your+exact+net+pay+after+all+taxes+%E2%80%94+All+50+states", width: 1200, height: 630, alt: "Take Home Pay Calculator — Dayblip" }],
  },
