...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.dayblip.com/api/og?title=Compound+Interest+Calculator&emoji=%F0%9F%93%88&subtitle=Watch+your+money+grow+year+by+year+%E2%80%94+Free", width: 1200, height: 630, alt: "Compound Interest Calculator — Dayblip" }],
  },
  twitter: { card: "summary_large_image", images: ["https://www.dayblip.com/api/og?title=Compound+Interest+Calculator&emoji=%F0%9F%93%88&subtitle=Watch+your+money+grow+year+by+year+%E2%80%94+Free"] },
}
