...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/api/og?title=Paycheck+Calculator&emoji=%F0%9F%A7%BE&subtitle=Net+pay+after+federal+state+%26+FICA+taxes+%E2%80%94+Free", width: 1200, height: 630, alt: "Paycheck Calculator — Dayblip" }],
  },
