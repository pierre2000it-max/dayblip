...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/api/og?title=Pregnancy+Due+Date+Calculator&emoji=%F0%9F%91%B6&subtitle=Calculate+your+due+date+and+trimester+timeline+%E2%80%94+Free", width: 1200, height: 630, alt: "Pregnancy Due Date Calculator — Dayblip" }],
  },
