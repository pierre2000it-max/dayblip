...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", images: ["https://www.dayblip.com/api/og?title=Pregnancy+Due+Date+Calculator&emoji=%F0%9F%91%B6&subtitle=Calculate+your+due+date+and+trimester+timeline+%E2%80%94+Free&v=2"] },
}
