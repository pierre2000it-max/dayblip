...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/api/og?title=Calorie+Calculator&emoji=%F0%9F%A5%97&subtitle=Daily+calorie+needs+for+your+goal+%E2%80%94+Free", width: 1200, height: 630, alt: "Calorie Calculator — Dayblip" }],
  },
