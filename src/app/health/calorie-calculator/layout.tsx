...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.dayblip.com/api/og?title=Calorie+Calculator&emoji=%F0%9F%A5%97&subtitle=Daily+calorie+needs+for+your+goal+%E2%80%94+Free&v=2", width: 1200, height: 630, alt: "Calorie Calculator — Dayblip" }],
  },
  twitter: { card: "summary_large_image", images: ["https://www.dayblip.com/api/og?title=Calorie+Calculator&emoji=%F0%9F%A5%97&subtitle=Daily+calorie+needs+for+your+goal+%E2%80%94+Free&v=2"] },
}
